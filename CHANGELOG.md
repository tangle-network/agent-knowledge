...
Allow consumers to install public Eval 0.190 alongside Knowledge after packed-package and official optimizer checks.
Keep the previously supported Eval 0.182 through 0.189 releases; the 0.190 development pin replaces 0.182.

## 17.1.4 — 2026-09-25

Allow consumers to install public Eval 0.188 and 0.189 alongside Knowledge after packed-package and official optimizer checks.
Keep the 0.182 development pin and the previously supported Eval 0.182 through 0.187 releases.

## 17.1.3 — 2026-09-24

Allow consumers to install public Eval 0.187 alongside Knowledge after packed-package and official optimizer checks.
Keep the 0.182 development pin and the previously supported Eval 0.182 through 0.186 releases.
...
- The `agent-eval` peer moves to `>=0.173.0 <0.174.0` and the development dependency to 0.173.0, so a consumer on eval 0.173.x installs one coherent cohort.
No code change; the suite runs against 0.173.0.
